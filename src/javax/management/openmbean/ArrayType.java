...
public class ArrayType<T> extends OpenType<T> {
    ...
    public boolean isValue(Object obj) {
        ...
        // test.Test if obj's class name is the same as for the array values that this instance describes
    ...
    public boolean equals(Object obj) {
        ...
        // test.Test if other's elementType field is the same as for this instance
        //
        if (!this.elementType.equals(other.elementType)) {
            return false;
        }

        // test.Test if other's primitiveArray flag is the same as for this instance
        //
